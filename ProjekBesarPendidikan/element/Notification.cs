    ...
    public partial class Notification : Form
    {
        ...
        public Notification(string title, string body)
        {
            ...
            if (title.Equals("Warning")) {
                P_Circle.FillColor = Color.Gold;
                p_Sidebar.BackColor = Color.Gold;
            }

            if (title.Equals("Successfully"))
            {
                P_Circle.FillColor = Color.Green;
                p_Sidebar.BackColor = Color.Green;
            }
            lifeTimer.Interval = duration;
            labelTitle.Text = title;
            labelBody.Text = body;
            _animator = new FormAnimator(this, FormAnimator.AnimationMethod.Slide, FormAnimator.AnimationDirection.Down, 500);
            //windows border
